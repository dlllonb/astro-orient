...
#define USBD_MANUFACTURER_STRING      "Astro Orient"
#define USBD_PRODUCT_FS_STRING        "Astro Orient Environmental Sensor"
#define USBD_CONFIGURATION_FS_STRING  "Astro Orient CDC"
#define USBD_INTERFACE_FS_STRING      "Environmental Data"
